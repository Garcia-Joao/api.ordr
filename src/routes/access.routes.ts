...
router.get('/permissions', requireAuth, requirePermission('roles.view', 'roles.manage', 'users.view', 'users.manage'), getPermissionCatalog)
...
router.get('/event-dates', requireAuth, requirePermission('users.view', 'users.manage', 'events.active.assign', 'events.manage'), getAssignableEventDates)
