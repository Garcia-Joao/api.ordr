...
exports.ALL_PERMISSION_KEYS = exports.PERMISSION_CATALOG = void 0;
...
exports.ALL_PERMISSION_KEYS = exports.PERMISSION_CATALOG.flatMap((group) => group.permissions.map((permission) => permission.key));
function isKnownPermission(permissionKey) {
    return exports.ALL_PERMISSION_KEYS.includes(permissionKey);
}
