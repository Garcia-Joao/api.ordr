...
adminRouter.delete('/users/:userId', admin_auth_middleware_1.requirePlatformAdmin, admin_controller_1.adminDeleteUserController);
...
adminRouter.delete('/license-plans/:id', admin_auth_middleware_1.requirePlatformAdmin, admin_controller_1.adminDeleteLicensePlanController);
...
adminRouter.delete('/companies/:companyId', admin_auth_middleware_1.requirePlatformAdmin, admin_controller_1.adminDeleteCompanyController);
...
adminRouter.patch('/company-licenses/:licenseId', admin_auth_middleware_1.requirePlatformAdmin, admin_controller_1.adminUpdateCompanyLicenseController);
adminRouter.delete('/company-licenses/:licenseId', admin_auth_middleware_1.requirePlatformAdmin, admin_controller_1.adminDeleteCompanyLicenseController);
