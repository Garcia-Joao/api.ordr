...
router.post('/access-code', auth_middleware_1.requireAuth, (0, require_permission_middleware_1.requirePermission)('suppliers.view', 'suppliers.manage'), suppliers_controller_1.addSupplierAccessByCodeController);
